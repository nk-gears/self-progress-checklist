<template>
  <div class="p-4 space-y-4 max-w-lg mx-auto">
    ...
    <div class="card space-y-3">
      <div class="flex items-center gap-2 pb-2 border-b border-primary-50">
        <span class="text-primary-600 font-bold text-sm bg-primary-100 w-6 h-6 rounded-full flex items-center justify-center">1</span>
        <h2 class="text-primary-800">Gyan</h2>
      </div>
      ...
      <div class="space-y-2">
        <div class="flex items-center gap-3">
          ...
          <div class="flex items-center gap-2 flex-shrink-0">
            <StarRating v-if="form.gyanMurali" v-model="form.gyanMuraliStars" />
            <button @click="form.gyanMurali = !form.gyanMurali; if (!form.gyanMurali) form.gyanMuraliStars = 0"
              class="relative w-12 h-6 rounded-full transition-colors duration-200 flex-shrink-0"
              :class="form.gyanMurali ? 'bg-primary-600' : 'bg-gray-200'"
            >
        ...
        <div v-if="form.gyanMurali" class="flex justify-between items-center pl-1">
          <StarRating v-model="form.gyanMuraliStars" />
          <span class="text-xs font-bold text-primary-600 bg-primary-50 px-2 py-0.5 rounded-lg">{{ form.gyanMuraliStars }} pts</span>
        </div>
      </div>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex items-center gap-2 flex-shrink-0">
          <span v-if="form.gyanRevision" class="text-xs font-bold text-primary-600 bg-primary-50 px-2 py-0.5 rounded-lg">5 pts</span>
          <button @click="form.gyanRevision = !form.gyanRevision"
            class="relative w-12 h-6 rounded-full transition-colors duration-200"
            :class="form.gyanRevision ? 'bg-primary-600' : 'bg-gray-200'"
          >
            <span class="absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow-sm transition-transform duration-200"
    ...
    <div class="card space-y-3">
      <div class="flex items-center gap-2 pb-2 border-b border-primary-50">
        <span class="text-primary-600 font-bold text-sm bg-primary-100 w-6 h-6 rounded-full flex items-center justify-center">2</span>
        <h2 class="text-primary-800">Yog</h2>
      </div>
      ...
      <div class="space-y-2">
        <div class="flex items-center gap-3">
          ...
          <button @click="form.yogAmritvela = !form.yogAmritvela; if (!form.yogAmritvela) form.yogAmritvelaStars = 0"
            class="relative w-12 h-6 rounded-full transition-colors duration-200 flex-shrink-0"
            :class="form.yogAmritvela ? 'bg-primary-600' : 'bg-gray-200'"
          >
            <span class="absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow-sm transition-transform duration-200"
        ...
        <div v-if="form.yogAmritvela" class="flex justify-between items-center pl-1">
          <StarRating v-model="form.yogAmritvelaStars" />
          <span class="text-xs font-bold text-primary-600 bg-primary-50 px-2 py-0.5 rounded-lg">{{ form.yogAmritvelaStars * 2 }} / 10 pts</span>
        </div>
      </div>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex items-center gap-2 flex-shrink-0">
          <span v-if="form.yogExtraHours > 0" class="text-xs font-bold text-primary-600 bg-primary-50 px-2 py-0.5 rounded-lg">{{ Math.floor(form.yogExtraHours * 10) }} pts</span>
          <select v-model="form.yogExtraHours"
            class="text-sm font-semibold text-primary-700 bg-primary-50 border border-primary-100 rounded-xl px-2 py-1 focus:outline-none focus:ring-2 focus:ring-primary-300"
          >
      ...
      <div class="space-y-2">
        <div class="flex items-center gap-3">
          ...
          <button @click="form.yogTrafficControl = !form.yogTrafficControl; if (!form.yogTrafficControl) form.yogTrafficStars = 0"
            class="relative w-12 h-6 rounded-full transition-colors duration-200 flex-shrink-0"
            :class="form.yogTrafficControl ? 'bg-primary-600' : 'bg-gray-200'"
          >
            <span class="absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow-sm transition-transform duration-200"
        ...
        <div v-if="form.yogTrafficControl" class="flex justify-between items-center pl-1">
          <StarRating v-model="form.yogTrafficStars" />
          <span class="text-xs font-bold text-primary-600 bg-primary-50 px-2 py-0.5 rounded-lg">{{ form.yogTrafficStars }} / 5 pts</span>
        </div>
      </div>
    </div>
    ...
    <div class="card space-y-3">
      <div class="flex items-center gap-2 pb-2 border-b border-primary-50">
        <span class="text-primary-600 font-bold text-sm bg-primary-100 w-6 h-6 rounded-full flex items-center justify-center">3</span>
        <h2 class="text-primary-800">Dharana <span class="text-gray-400 font-normal text-base">(Sanskar Parivartan)</span></h2>
      </div>
      ...
      <div>
        ...
        <div class="flex gap-2">
          <select v-model="form.dharanaAim"
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex items-center gap-2 flex-shrink-0">
          <span v-if="form.dharanaMorningPledge" class="text-xs font-bold text-primary-600 bg-primary-50 px-2 py-0.5 rounded-lg">5 pts</span>
          <button @click="form.dharanaMorningPledge = !form.dharanaMorningPledge"
            class="relative w-12 h-6 rounded-full transition-colors duration-200"
            :class="form.dharanaMorningPledge ? 'bg-primary-600' : 'bg-gray-200'"
          >
            <span class="absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow-sm transition-transform duration-200"
      ...
      <div class="space-y-2">
        <div class="flex items-center gap-3">
          ...
          <button @click="form.dharanaNightCheck = !form.dharanaNightCheck; if (!form.dharanaNightCheck) form.dharanaNightStars = 0"
            class="relative w-12 h-6 rounded-full transition-colors duration-200 flex-shrink-0"
            :class="form.dharanaNightCheck ? 'bg-primary-600' : 'bg-gray-200'"
          >
            <span class="absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow-sm transition-transform duration-200"
        ...
        <div v-if="form.dharanaNightCheck" class="flex justify-between items-center pl-1">
          <StarRating v-model="form.dharanaNightStars" />
          <span class="text-xs font-bold text-primary-600 bg-primary-50 px-2 py-0.5 rounded-lg">{{ form.dharanaNightStars }} / 5 pts</span>
        </div>
      </div>
    </div>
    ...
    <div class="card space-y-3">
      <div class="flex items-center gap-2 pb-2 border-b border-primary-50">
        <span class="text-primary-600 font-bold text-sm bg-primary-100 w-6 h-6 rounded-full flex items-center justify-center">4</span>
        <h2 class="text-primary-800">Seva</h2>
      </div>
      ...
      <div class="space-y-2">
        <div class="flex items-center gap-3">
          ...
          <button @click="form.sevaDone = !form.sevaDone; if (!form.sevaDone) form.sevaStars = 0"
            class="relative w-12 h-6 rounded-full transition-colors duration-200 flex-shrink-0"
            :class="form.sevaDone ? 'bg-primary-600' : 'bg-gray-200'"
          >
            <span class="absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow-sm transition-transform duration-200"
        ...
        <div v-if="form.sevaDone" class="flex justify-between items-center pl-1">
          <StarRating v-model="form.sevaStars" />
          <span class="text-xs font-bold text-primary-600 bg-primary-50 px-2 py-0.5 rounded-lg">{{ form.sevaStars }} / 5 pts</span>
        </div>
      </div>
    </div>
...
const loadForDate = () => {
  ...
  if (e) {
    ...
    Object.assign(form, {
      ...
      yogTrafficControl: false, yogTrafficStars: 0,
      dharanaAim: '', dharanaMorningPledge: false,
      dharanaNightCheck: false, dharanaNightStars: 0,
